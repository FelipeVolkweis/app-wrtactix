#include "barrierleft.hh"

SSLBarrierLeft::SSLBarrierLeft() : SSLRole(SSLRoleType::BARRIERLEFT) {}

PlayerID SSLBarrierLeft::getRoleAssignment(const World &world, const QHash<PlayerID, bool> &assignmentTable) {
